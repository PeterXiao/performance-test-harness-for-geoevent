...
public class UIMessages {
     ...
     *
     * @param key of the message to look up.
     * @return the message
     */
    ...
    /**
     * Pass through method to the {@link Messages#getMessage(String, Object...)}
     * method.
     *
     * @param key of the message to look up.
     * @param params optional parameters to be used when constructing the
     * message string reference {@link MessageFormat#format(String, Object...)}
     * @return the message
     */
    ...
    /**
     * Protected helper method to get keep of the these messages in a static
     * way.
     *
